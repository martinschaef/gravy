 ...
 */
public class RocketScienceTransitionRelation extends AbstractTransitionRelation {
...
//	}
	...
	public RocketScienceTransitionRelation(CfgProcedure cfg, AbstractControlFlowFactory cff, Prover p) {
		super(cfg, cff, p);
		makePrelude();
