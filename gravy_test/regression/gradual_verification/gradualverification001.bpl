...
const { :SourceLocation "String.java",-1,-1,-1,-1 } unique java.lang.String : javaType extends  unique java.lang.CharSequence, unique java.lang.Comparable, unique java.io.Serializable, unique java.lang.Object complete;
...
const { :SourceLocation "Class.java",-1,-1,-1,-1 } unique java.lang.Class : javaType extends  unique java.io.Serializable, unique java.lang.reflect.AnnotatedElement, unique java.lang.Object, unique java.lang.reflect.GenericDeclaration, unique java.lang.reflect.Type complete;
...
const { :SourceLocation "Method.java",-1,-1,-1,-1 } unique java.lang.reflect.Method : javaType extends  unique java.lang.reflect.GenericDeclaration, unique java.lang.reflect.Member, unique java.lang.reflect.AccessibleObject complete;
...
const { :SourceLocation "StringBuilder.java",-1,-1,-1,-1 } unique java.lang.StringBuilder : javaType extends  unique java.lang.CharSequence, unique java.io.Serializable, unique java.lang.AbstractStringBuilder complete;
...
const { :SourceLocation "Field.java",-1,-1,-1,-1 } unique java.lang.reflect.Field : javaType extends  unique java.lang.reflect.Member, unique java.lang.reflect.AccessibleObject complete;
...
const { :SourceLocation "ArrayList.java",-1,-1,-1,-1 } unique java.util.ArrayList : javaType extends  unique java.util.AbstractList, unique java.io.Serializable, unique java.util.RandomAccess, unique java.util.List, unique java.lang.Cloneable complete;
...
const { :SourceLocation "Constructor.java",-1,-1,-1,-1 } unique java.lang.reflect.Constructor : javaType extends  unique java.lang.reflect.GenericDeclaration, unique java.lang.reflect.Member, unique java.lang.reflect.AccessibleObject complete;
...
const { :SourceLocation "Set.java",-1,-1,-1,-1 } unique java.util.Set : javaType extends  unique java.lang.Object, unique java.util.Collection complete;
...
const { :SourceLocation "HashSet.java",-1,-1,-1,-1 } unique java.util.HashSet : javaType extends  unique java.io.Serializable, unique java.util.Set, unique java.lang.Cloneable, unique java.util.AbstractSet complete;
...
const { :SourceLocation "TreeMap.java",-1,-1,-1,-1 } unique java.util.TreeMap : javaType extends  unique java.io.Serializable, unique java.util.NavigableMap, unique java.lang.Cloneable, unique java.util.AbstractMap complete;
const { :SourceLocation "HashMap.java",-1,-1,-1,-1 } unique java.util.HashMap : javaType extends  unique java.io.Serializable, unique java.util.Map, unique java.lang.Cloneable, unique java.util.AbstractMap complete;
...
const { :SourceLocation "DefaultHandler.java",-1,-1,-1,-1 } unique org.xml.sax.helpers.DefaultHandler : javaType extends  unique org.xml.sax.DTDHandler, unique org.xml.sax.ErrorHandler, unique org.xml.sax.EntityResolver, unique java.lang.Object, unique org.xml.sax.ContentHandler complete;
...
const { :SourceLocation "Format.java",-1,-1,-1,-1 } unique java.text.Format : javaType extends  unique java.io.Serializable, unique java.lang.Object, unique java.lang.Cloneable complete;
...
const { :SourceLocation "MethodSetter.java",-1,-1,-1,-1 } unique org.kohsuke.args4j.spi.MethodSetter : javaType extends  unique java.lang.Object, unique org.kohsuke.args4j.spi.Setter complete;
...
const { :SourceLocation "MapSetter.java",-1,-1,-1,-1 } unique org.kohsuke.args4j.MapSetter : javaType extends  unique java.lang.Object, unique org.kohsuke.args4j.spi.Setter complete;
...
const { :SourceLocation "MultiValueFieldSetter.java",-1,-1,-1,-1 } unique org.kohsuke.args4j.spi.MultiValueFieldSetter : javaType extends  unique java.lang.Object, unique org.kohsuke.args4j.spi.Setter complete;
const { :SourceLocation "FieldSetter.java",-1,-1,-1,-1 } unique org.kohsuke.args4j.spi.FieldSetter : javaType extends  unique java.lang.Object, unique org.kohsuke.args4j.spi.Setter complete;
...
const { :SourceLocation "ParameterizedType.java",-1,-1,-1,-1 } unique java.lang.reflect.ParameterizedType : javaType extends  unique java.lang.Object, unique java.lang.reflect.Type complete;
